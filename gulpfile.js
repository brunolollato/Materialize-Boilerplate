...
//compressing img & handle SVG files
...
gulp.task('html-deploy', function() {
    ...
    gulp.src(['app/styles/*.css', '!app/styles/app.css'])
        //prevent pipe breaking caused by errors from gulp plugins
        .pipe(plumber())
        .pipe(gulp.dest('dist/styles'));
});
...
gulp.task('deploy', gulpSequence('clean', 'scaffold', ['scripts-deploy', 'styles-deploy', 'img-deploy'], 'html-deploy'));
